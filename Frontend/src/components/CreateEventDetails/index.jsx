...
function CreateEventDetails(props) {
  ...
  let startBorder, endBorder

  if(eventStartTime != ''){
    startBorder = 'border-1px-dove-gray'
  }else startBorder = 'border-1px-dove-red'
  if(eventEndTime != ''){
    endBorder = 'border-1px-dove-gray'
  }else endBorder = 'border-1px-dove-red'

  if(eventDate == '' || eventStartTime == '' || eventEndTime == '' || eventCapacity == '' || eventPrice == ''){
    return (
      <div className="createevent-details screen">
        ...
        <HostName inputPlaceholder={hostName1Props.inputPlaceholder} childToParent={handleEventDate} currentValue={eventDate} fieldType={"date"} />
          <div className="gruppe2">
            <div className={`start-time ${startBorder}`}>
              <input
            ...
            <div className={`end-time ${endBorder}`}>
              <input
